...
<!-- Paste the relevant excerpt from KOBOeReader/.adds/nickel-cover-fix/nickel-cover-fix.log for
     the affected flow (the startup block plus the lines around your change). Set ncf_log:1 or
     ncf_mode:observe to capture the page-turn traces. -->
